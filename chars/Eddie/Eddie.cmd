...
trigger1 = (p2bodydist x <= 90) && (prevstateno != 5120) && (p2movetype != H) && (statetype != A)
value = 1000
...
trigger1 = (power >= 1000) && (numproj = 0) && (random = [0,3000])
...
triggerall = (roundstate = 2) && (var(59) != 0)
triggerall = (Ctrl) && (Statetype = S) && (p2statetype != L)
trigger1 = (p2bodydist x <= 30) && (prevstateno != 5120) && (numproj = 0) && (statetype != S)
...
trigger1 = (p2bodydist x <= 60) && (prevstateno != 5120) && (numproj = 0) && (statetype != S)
trigger1 = (power >= 3000) && (numproj = 0) && (random = [0,300])
...
[State -1, Beer Bottle Throw]
type = ChangeState
value = 1000
triggerall = command = "bottle"
...
type = ChangeState
value = 3200
triggerall = command = "supershotgun"
triggerall = NumHelper(3201) = 0
