...
; 
; ;---------------------------------------------------------------------------
;Breegull Smasher (uses one super bar)
[State -1, Breegull Smasher]
type = ChangeState
value = 3500
...
trigger1 = ctrl
;-----------------------------------------------------------------------------
;Mumbo Summon 1 Zap Stick
[State -1, Mumbo Summon 1 Zap Stick]
type = ChangeState
value = 8500
triggerall = statetype != A
triggerall = numhelper = 0
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 200) && movecontact && time > 1
;---------------------------------------------------------------------------
; ;Stand Light Kick
; ;立ち弱キック
