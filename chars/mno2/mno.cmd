...
;---------------------------------------------------------------------------
;Sky Attack (uses one super bar)
;三烈カンフー突き手（ゲージレベル１）
[State -1, Sky Attack]
type = ChangeState
value = 3001
triggerall = command = "Sky Attack"
